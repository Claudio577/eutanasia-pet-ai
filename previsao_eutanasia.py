...
def prever(texto):
    ...
    # DETECÇÃO DE DOENÇAS LEGAIS COM DEBUG
    doencas_detectadas = []
    ...
    # DEBUG: mostrar quais doenças foram detectadas e flag tem_doenca_letal
    ...
    # FORÇAR CHANCE DE EUTANÁSIA PARA 95% SE QUALQUER DOENÇA LETAL FOR DETECTADA
    if tem_doenca_letal == 1:
        st.write("⚠️ Doença letal detectada - Forçando chance de eutanásia para 95%")
...
# NORMALIZAR DOENÇAS NO DATAFRAME PARA FLAG tem_doenca_letal
